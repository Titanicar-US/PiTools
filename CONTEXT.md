...
- Published validation head `ccbb0a69062ea0569a79f1d18957445dc7c82f18` passed the [source workflow](https://github.com/Titanicar-US/PiTools/actions/runs/31381238456) and [core/runner image workflow](https://github.com/Titanicar-US/PiTools/actions/runs/31381238515). The source workflow has no repository-owned warnings; the image workflow passed with upstream Docker action Node 20 runtime and BuildKit no-output warnings, and its release-only publication job was skipped as designed.
