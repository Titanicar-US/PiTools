...
- Code-bearing validation head `5e9814fd83cad898078b4dcff43185654999a4cd` passed the exact-head [source workflow](https://github.com/Titanicar-US/PiTools/actions/runs/31390203425) and [core/runner image workflow](https://github.com/Titanicar-US/PiTools/actions/runs/31390203346). The source check, core image, and runner image are green; pull-request image publication remains intentionally skipped because PR #1 is draft, and the post-merge publisher is release-tag-only.
