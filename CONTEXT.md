...
- GitHub Actions PR checks for the published branch have passed after updating checkout/setup-node to Node 24-compatible pinned releases; the current hosted run is [31378395796](https://github.com/Titanicar-US/PiTools/actions/runs/31378395796), and no deprecation annotation remains.
